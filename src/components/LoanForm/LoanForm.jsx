...
const LoanForm = () => {
    ...
    return (
        ...
        <>
            {
                mounted && modal && createPortal(<div className=" bg-black/30 backdrop-blur-sm absolute top-0  h-full  w-full grid place-items-center ">
                    <button onClick={() => {
                        setModal(false)
                    }} className="absolute top-3 right-3 text-white"><IoMdClose size={30} /></button>
                    ...
                    <main className=" w-full mx-auto max-w-7xl h-[80vh] flex  ">
                        <div className="relative flex-1 hidden items-center justify-center h-full bg-slate-300 lg:flex">
                            <div className="bg-card rounded-lg p-6 shadow-sm">
                                <h2 className="text-2xl font-bold mb-4">Covid-19 Guidelines</h2>
                            ...
                            <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                                <div className="">
                                    ...
                                    <div className="mt-5 space-y-2">
                                        <h3 className="text-gray-800 text-2xl font-bold sm:text-3xl">Enquiry Form</h3>
