                        ...
                        <div className="w-2/3 p-6 bg-whtie text-red-500 flex flex-col justify-between">
                            ...
                            <div className="mt-4">
                                <div className="flex justify-between items-center">
                                    <span className="font-bold text-xl">₹ 36,00,000</span>
                                    <div className="flex items-center text-sm">
                                        <span className="mr-2">Auction Starts:</span>
                                        <span className="font-semibold">11-10-2024 01:00 PM</span>
                                    </div>
                                </div>
                                <div className="flex justify-between items-center mt-4">
                                    ...
                                    <button className="bg-white text-red-500 border-2 border-red-500 hover:ring-4 ring-red-500/30 transition-all px-4 py-2 rounded-lg  transition-colors duration-300">
                                        View More
                                    </button>
                                </div>
                            </div>
